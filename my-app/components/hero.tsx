...
const [scroll, setScroll] = useState(false)
    ...
    return(
        ...
        <article className="grid  h-screen overflow-hidden ">
            <div className="col-start-1 row-start-1 z-10 justify-center mt-30 mx-auto center p-1 md:mt-44   ">
                <h1 className="text-6xl de font-sans duration-150 text-center grid justify-self-center h-60 mx-auto md:max-w-3/4  ">
            ...
            <section  className="bg-black w-[70%] max-w-xl justify-self-center p-10 mb-11 rounded-3xl duration-200 rotate-x-50 rotate-z-45 shadow-2xl flex gap-2 h-[25vh] overflow-hidden  md:h-80  md:w-90%">
             ...
             <form className=" flex flex-col gap-3 max-w-1/3 " action="">
